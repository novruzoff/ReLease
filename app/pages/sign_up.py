...
layout = html.Div([
        dbc.Container(
            ...
            children=[
                ...
                dbc.Row([
                        dbc.Col(html.H1(
                                "Create an Account to View & Post Listings!", className="text-center my-5"
                                ),
                            width=12
                        )
                ]),
                ...
                dbc.Row([
                    html.Div([
                        # Sign up Header
                        dbc.Col(
                            html.H3("Sign Up", className="text-center my-4"),
                        ),
                        ...
                        # Submit Button
                        dbc.Col([
                            dbc.Button('Sign up', color='primary', className='my-3 fw-bold', style={'width':'450px', 'display': 'block', 'margin': 'auto'})
                        ])
